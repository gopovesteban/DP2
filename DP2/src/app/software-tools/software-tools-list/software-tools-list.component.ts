...
export class SoftwareToolsListComponent implements OnInit {
  ...
  softwareTools: SoftwareTileModel[] = [
    new SoftwareTileModel('Jazz DNG', 'assets/images/compliant.jpg', 'COMPLIANT', 'iFix11.5', [new SoftwareToolVersionModel('Jazz DNG', 'COMPLIANT', 'iFix11.5', '12/12/12', 'https://wiki.ith.intel.com/display/IFSTC/Intel+Functional+Safety+Tool'), new SoftwareToolVersionModel('Jazz DNG', 'COMPLIANT', 'iFix11.3', '12/12/12', 'https://wiki.ith.intel.com/display/IFSTC/Intel+Functional+Safety+Tool')]),
    new SoftwareTileModel('Jazz DNG', 'assets/images/nonCompliant.jpg', 'COMPLIANT', 'iFix11.5', [new SoftwareToolVersionModel('Jazz DNG', 'COMPLIANT', 'iFix11.5', '12/12/12', 'LINK'), new SoftwareToolVersionModel('Jazz DNG', 'COMPLIANT', 'iFix11.3', '12/12/12', 'LINK')]),
